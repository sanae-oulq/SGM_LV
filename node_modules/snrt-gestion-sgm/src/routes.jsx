...
const routes = [
  ...
  },
  {
    ...
    routes: [
      ...
      {
        exact: 'true',
        path: '/tables/bootstrap-SituationMarche',
        element: lazy(() => import('./views/tables/BootstrapTable-SituationMarche'))
      },

      {
        exact: 'true',
        path: '/tables/bootstrap-ListeSN',
        element: lazy(() => import('./views/tables/BootstrapTable-ListeSN'))
      },
      ...
      {
        exact: 'true',
        path: '/tables/bootstrap-Stock',
        element: lazy(() => import('./views/tables/BootstrapTable-Stock'))
      },
