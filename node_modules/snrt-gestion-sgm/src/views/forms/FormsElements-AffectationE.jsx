...
import { FaArrowLeft, FaTrash, FaFileUpload, FaSignature, FaFile, FaDownload, FaFileAlt, FaPlus, FaSave, FaPrint, FaSearch, FaCalendarAlt, FaUserAlt, FaMapMarkerAlt, FaStar, FaClipboardList, FaComments, FaCheck, FaTimes, FaEdit } from 'react-icons/fa';
...
const FormsElements = () => {
  ...
  const handleValidate = () => {
    if (!selectedService || !selectedChaine) {
      setValidationMessage('Veuillez sélectionner un service et une chaîne.');
                    ...
                    <Col md={6}>
                      <Form.Group className="mb-3">
                        ...
                        <InputGroup>
                            ...
                            <Button variant="secondary" onClick={toggleReferencePopup}>🔍</Button>
                        </InputGroup>
                          {showReferencePopup && (
                            <div className="popup">
                              <Form.Control
