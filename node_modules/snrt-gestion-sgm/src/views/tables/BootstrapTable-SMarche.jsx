...
const BootstrapTable = () => {
  ...
  const fetchReceptionData = async () => {
    try {
      ...
      // Transformer les données pour extraire les informations
        ...
        <Col>
          <Card>
            <Card.Header style={{ padding: '0.5rem 1rem', background: '#f8f9fa', borderBottom: '1px solid #e9ecef' }}>
              <Card.Title as="h5" style={{ fontSize: '1rem', marginBottom: '0.25rem' }}>Liste Prix</Card.Title>
              <span className="d-block" style={{ fontSize: '0.875rem', color: '#6c757d' }}>
                Tableau <code>Prix</code>
              </span>
            </Card.Header>
                ...
                <Table hover responsive>
                  <thead>
                    <tr>
                      ...
                      <th style={styles.tableHeader}>Type Produit</th>
